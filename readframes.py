...
timemor = np.linespace(start=0, stop=len(ondaconvertida)/frameratemor, num=len(ondaconvertida))
timeaf = np.linespace(start=0, stop=len(ondaconvertidaaf)/framerateaf, num=len(ondaconvertidaaf))
timeh = np.linespace(start=0, stop=len(ondaconvertidah)/framerateh, num=len(ondaconvertidah))
timeb = np.linespace(start=0, stop=len(ondaconvertidab)/framerateb, num=len(ondaconvertidab))
